...
exports.loadProject = function(proj) {
...
// Returns rue if its okay to close the project
...
exports.getNewAssetId = function() {
    settings.setNumAssets(settings.settings.numAssets + 1)
...
exports.getEmptyCharacter = function(dontIncrement) {
