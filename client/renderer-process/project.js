...
module.exports = {
	...
	readProject: function() {
		...
		fs.readJson(filepath, (err, proj) => {
			...
			this.project.nickname = this.nicknames[Math.floor(Math.random() * this.nicknames.length)]
    ...
    nicknames: [	// taken from https://wiki.urealms.com/wiki/List_of_Minor_Characters - Updated 2018-01-08
        "Albert",
        "Jolt Billbottom",
        "Monkey Fish King",
        "Nessie",
